...
const SignUpPage = () => {
  return (
    ...
    <div className='flex flex-row justify-center items-center w-screen h-[90vh] mt-10'>
            <div className="flex min-h-full flex-col justify-center items-center   px-6 py-12 lg:px-8 border lg:w-[50vw] sm:w-[90vw] h-[50vh] border-white">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form action="#" method="POST" className="space-y-6">
            <div>
              ...
              <div className="mt-2">
                <input id="text" type="text" name="fn" required  className="block w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-2">
                <input id="text" type="text" name="ln" required  className="block w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6" />
              </div>
            </div>
